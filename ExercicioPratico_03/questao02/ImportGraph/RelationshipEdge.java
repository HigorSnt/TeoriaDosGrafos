...
public class RelationshipEdge extends DefaultEdge
{
    ...
    // atributos da classe ImportGraph.RelationshipEdge.
    private Object v1;
    private Object v2;
    private Map<String, Attribute> att;

    /**
     * Construtor da classe ImportGraph.RelationshipEdge. Instancializa os atributos da classe.
     *
     * @param v1  vertice 1
     * @param v2  vertice 2
    ...
    public Object getLabel()
    {
        ...
        if (o == null)
        { // analisa se este eh nulo. se for verdade...
    ...
    {
        if (v.equals(v1))
        { // compara o vertice passado como paramentro com o vertice v1. caso sejam
            // iguais...
    ...
    public String toString()
    {
        ...
        if (o == null)
        { // analisa se este eh nulo. se for...
